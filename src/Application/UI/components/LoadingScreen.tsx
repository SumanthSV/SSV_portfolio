        ...
        >
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Sumanth SV Portfolio Showcase 2024</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
                            ...
                            <br/>
                            <div>
                                <p><b> To continue with Mobile View </b><a style={{color:'red',textDecoration:'none'}} href="https://sumanthsv.github.io/SSV_portfolio/">Click here..</a></p>
                            </div>
                    ...
                    <div style={styles.startPopup}>
                        ...
                        <p>
                            ...
                            <a
                                style={styles.link}
                                href={
                                    'https://github.com/sumanthsv04/SSV_portfolio/issues/6'
                                }
                            >
                                bug in firefox
                            </a>
